...
</table>`, stats.numbers, len(stats.numbers), stats.mean, stats.median, stats.mode, stats.stand_dev)
}
...
func getStats(numbers []float64) (stats statistics) {
    ...
    stats.stand_dev = stand_dev(numbers, stats.mean)
...
func stand_dev(numbers []float64, mean float64) float64 {
     var total float64
    ...
    stand_dev_result := math.Sqrt(numerator/denominator)

    return stand_dev_result
}
